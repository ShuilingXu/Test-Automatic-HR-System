...
class PayrollCalculationsTest {
    ...
    @Test void cumulativeWithholdingCrossesTaxBracket() { assertEquals(new BigDecimal("11880.00"), PayrollCalculations.cumulativeTax(new BigDecimal("144000"))); assertEquals(new BigDecimal("1200.00"), PayrollCalculations.currentWithholding(new BigDecimal("144000"), new BigDecimal("10680"))); }
    ...
    @Test void growthExcludesUnconfirmedAndMissingPriorMonth() { assertNull(PayrollCalculations.growth(new BigDecimal("10000"),null,true));assertNull(PayrollCalculations.growth(new BigDecimal("10000"),new BigDecimal("9000"),false));assertEquals(new BigDecimal("11.11"),PayrollCalculations.growth(new BigDecimal("10000"),new BigDecimal("9000"),true)); }
