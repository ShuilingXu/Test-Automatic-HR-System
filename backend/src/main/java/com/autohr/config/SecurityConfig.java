    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/admin/**").hasAnyRole("IT_ADMIN", "HR_ADMIN")
                        ...
                        .requestMatchers("/api/interview/it/**").hasRole("IT_ADMIN")
                        .requestMatchers("/api/interview/hr/**").hasAnyRole("IT_ADMIN", "HR_ADMIN", "HR_USER")
                        .requestMatchers("/api/interview/interviewee/**").hasRole("INTERVIEWEE")
