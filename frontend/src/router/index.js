...
const routes = [
  ...
  { path: '/admin/content', name: 'admin-content', component: ConsoleView, meta: { requiresAuth: true, roles: ['IT_ADMIN', 'HR_ADMIN'], consoleTab: 'content' } },
  ...
  { path: '/interview/hr/llm-configs', name: 'interview-llm-configs', component: InterviewAdminView, meta: { requiresAuth: true, roles: ['IT_ADMIN'], interviewTab: 'system' } },
  { path: '/interview/hr/llm-configs/:id', name: 'interview-llm-config-detail', component: InterviewAdminView, meta: { requiresAuth: true, roles: ['IT_ADMIN'], interviewTab: 'system' } },
  ...
  { path: '/interview/hr/templates', name: 'interview-process-templates', component: InterviewAdminView, meta: { requiresAuth: true, roles: ['IT_ADMIN', 'HR_ADMIN', 'HR_USER'], interviewTab: 'template' } },
