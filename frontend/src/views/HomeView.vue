  ...
  <div class="public-site">
    <header class="site-header">
      <RouterLink class="brand" to="/">
        ...
        <span><strong>{{ site.title }}</strong><small>人才与组织中心</small></span>
      </RouterLink>
    ...
    <main>
      <section class="hero-band">
        <div class="hero-copy">
          ...
          <p class="hero-lead">{{ site.heroDescription }}</p>
    ...
    <footer class="site-footer"><span>{{ site.title }} · 人才与组织中心</span><RouterLink to="/login">管理员登录</RouterLink></footer>
  </div>
</template>
...
const site = { title: '千早爱音', heroTitle: '让合适的人，找到值得投入的事。', heroDescription: '我们相信，好的组织从一次坦诚的对话开始。了解团队、浏览机会，开启你的下一段职业旅程。' }
const jobs = ref([])
const updates = ref([])
...
.brand-mark { display: grid; place-items: center; width: 34px; height: 34px; background: #175c50; color: #fff; font-weight: 800; border-radius: 8px; }
.brand strong, .brand small { display: block; }.brand strong { font-size: 15px; }.brand small { color: #75827d; font-size: 11px; margin-top: 2px; }
