  ...
  <div class="page-shell console-shell">
    ...
    <main class="console-main">
      ...
      <section v-if="activeTab === 'recruitment'" class="page-card">
        ...
        <div class="sub-tabs"><button :class="{ active: recruitmentMode === 'jobs' }" @click="recruitmentMode = 'jobs'">增 / 删 / 改岗位信息</button><button :class="{ active: recruitmentMode === 'candidates' }" @click="recruitmentMode = 'candidates'">候选人信息</button></div>
        <template v-if="recruitmentMode === 'jobs'">
          ...
          <div class="action-row"><el-button type="primary" @click="saveJob">保存岗位</el-button><el-button @click="resetJobForm">清空</el-button></div>
