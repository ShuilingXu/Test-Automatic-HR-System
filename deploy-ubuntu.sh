...
ALIYUN_STT_APP_KEY="${ALIYUN_STT_APP_KEY:-}"
ALIYUN_STT_ENDPOINT="${ALIYUN_STT_ENDPOINT:-}"
...
prepare_env() {
  ...
  ALIYUN_ACCESS_KEY_ID="${ALIYUN_ACCESS_KEY_ID:-$(get_env_value ALIYUN_ACCESS_KEY_ID)}"
  ALIYUN_ACCESS_KEY_SECRET="${ALIYUN_ACCESS_KEY_SECRET:-$(get_env_value ALIYUN_ACCESS_KEY_SECRET)}"
  ALIYUN_SMS_SIGN_NAME="${ALIYUN_SMS_SIGN_NAME:-$(get_env_value ALIYUN_SMS_SIGN_NAME)}"
  ALIYUN_SMS_TEMPLATE_CODE="${ALIYUN_SMS_TEMPLATE_CODE:-$(get_env_value ALIYUN_SMS_TEMPLATE_CODE)}"
  ALIYUN_STT_APP_KEY="${ALIYUN_STT_APP_KEY:-$(get_env_value ALIYUN_STT_APP_KEY)}"
  ALIYUN_STT_ENDPOINT="${ALIYUN_STT_ENDPOINT:-$(get_env_value ALIYUN_STT_ENDPOINT)}"
  ALIYUN_STT_ENDPOINT="${ALIYUN_STT_ENDPOINT:-nls-gateway-cn-shanghai.aliyuncs.com}"
  ALIYUN_OSS_BUCKET_NAME="${ALIYUN_OSS_BUCKET_NAME:-$(get_env_value ALIYUN_OSS_BUCKET_NAME)}"
  ALIYUN_OSS_ENDPOINT="${ALIYUN_OSS_ENDPOINT:-$(get_env_value ALIYUN_OSS_ENDPOINT)}"
  SMTP_HOST="${SMTP_HOST:-$(get_env_value SMTP_HOST)}"
  SMTP_PORT="${SMTP_PORT:-$(get_env_value SMTP_PORT)}"
  SMTP_USERNAME="${SMTP_USERNAME:-$(get_env_value SMTP_USERNAME)}"
  SMTP_PASSWORD="${SMTP_PASSWORD:-$(get_env_value SMTP_PASSWORD)}"
  SMTP_FROM="${SMTP_FROM:-$(get_env_value SMTP_FROM)}"
  SMTP_SSL="${SMTP_SSL:-$(get_env_value SMTP_SSL)}"
  ...
  set_env_value ALIYUN_ACCESS_KEY_ID "$ALIYUN_ACCESS_KEY_ID"
  set_env_value ALIYUN_ACCESS_KEY_SECRET "$ALIYUN_ACCESS_KEY_SECRET"
  set_env_value ALIYUN_SMS_SIGN_NAME "$ALIYUN_SMS_SIGN_NAME"
  set_env_value ALIYUN_SMS_TEMPLATE_CODE "$ALIYUN_SMS_TEMPLATE_CODE"
  set_env_value ALIYUN_STT_APP_KEY "$ALIYUN_STT_APP_KEY"
  set_env_value ALIYUN_STT_ENDPOINT "$ALIYUN_STT_ENDPOINT"
  set_env_value ALIYUN_OSS_BUCKET_NAME "$ALIYUN_OSS_BUCKET_NAME"
  set_env_value ALIYUN_OSS_ENDPOINT "$ALIYUN_OSS_ENDPOINT"
  ...
  set_env_value SMTP_SSL "$SMTP_SSL"
}
